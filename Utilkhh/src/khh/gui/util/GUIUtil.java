...
public class GUIUtil{
	...
	// public static GridBagConstraints getGridBagConstraints(int x, int y, int
	...
	public static void setIcon(Frame frame, File file) throws IOException{
		frame.setIconImage(ImageUtil.getImage(file));
	}
}
