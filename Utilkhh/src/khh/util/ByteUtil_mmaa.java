 ...
 * @version 	: 1.0
 * @since		: JDK1.4.2
 * 작  성  일 	: 2004. 01. 11 By Lee WonYoung
 * 변경  이력 	: 2009. 09. 23
 * 기      타 	: 
 */
public class ByteUtil
{
     ...
     * 
     * 	
     * @param singFlag : + 표현여부, false이면 +표시 안됨, true이면 +표시됨
     * @param type : 1이면 숫자형, 0이면 문자형
     * @param fillType : 0이면 뒤 공란 ' '채움, 1이면 앞공란을 0으로 채움, 2이면 앞에 ' ' 채움
     * @return byte[]
     * @throws
     */
