package khh.finger.remote.finmanager.worker;
...
public abstract class FingWorkerBase extends NioWorker {
	 ...
	 */
	public FingMsg receiveMsg(SelectionKey selectionKey) throws IOException {
		FingMsg msg = null;
		if(selectionKey.isReadable()){
			...
			if(i==1 && FingMsg.STX == buffer.get(0)){
				msg = new FingMsg();
...
//				msg.setAction(length);
				...
				if(i==1 && FingMsg.ETX ==buffer.get(0)){
	...
	public void sendMsg(FingMsg msg, SelectionKey selectionKey) throws Exception {
	...
	public abstract FingMsg onReceiveAction(FingMsg msg, SelectionKey selectionKey) throws Exception;
	public abstract FingMsg onSendAction(FingMsg msg, SelectionKey selectionKey) throws Exception;
