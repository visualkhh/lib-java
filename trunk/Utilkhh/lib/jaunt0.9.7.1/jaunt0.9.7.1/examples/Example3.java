...
public class Example3{
  public static void main(String[] args){
    try{
      ...
      System.out.println("body's text: " + body.getText());         //join immediate child text of body element
      System.out.println("body's innerText: " + body.innerText()); //join all text within body element
      System.out.println("div's text: " + div.getText());           //join immediate child of div element
