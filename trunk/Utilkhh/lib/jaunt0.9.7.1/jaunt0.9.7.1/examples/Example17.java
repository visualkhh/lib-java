...
public class Example17{
  public static void main(String[] args){
    try{
      ...
      Element element = table.getCell("fri", "10:00am");             //get td/th element at intersection of col/row
      System.out.println(element.outerHTML());                       //print element
      
      System.out.println("\nCell at position 3,3:");
      element = table.getCell(3,3);                                  //get td/th element at col index 3, row index 3
      System.out.println(element.outerHTML());                       //print element
    }
