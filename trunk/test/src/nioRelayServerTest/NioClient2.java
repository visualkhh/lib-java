...
//                 msg.setAction(NioActionMsg.ACTION.GET_SERVERTIME.getValue());
             ...
             //   msg.setAction(NioActionMsg.ACTION.GET_CLIENTS.getValue());
                msg.putParam(NioActionMsg.PARAM.FROM.getValue(), "client2");
                msg.putParam(NioActionMsg.PARAM.TO.getValue(), "client1");
...
//                msg.set("ClientRelayServer9090");
        ...
        NioClient client1 = new NioClient("127.0.0.1", 801, client1Worker);
        client1.connection();
        client1.start();
    }
}
